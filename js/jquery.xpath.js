...
(function () {
    ...
    cStaticContext.prototype.getURIForPrefix	= function(sPrefix) {
        ...
        if (sPrefix == "xmlns")
            return sNS_XNS;
        if (sPrefix == "defaultNamespace4321")
            return "*";
    ...
    function fNameTest_parse (oLexer, oStaticContext) {
        ...
        if (aMatch) {
            ...
            oLexer.next();
            return new cNameTest(aMatch[1] || null, aMatch[2], aMatch[1] ? aMatch[1] == '*' ? '*' : oStaticContext.getURIForPrefix(aMatch[1]) || null : oStaticContext.getURIForPrefix("defaultNamespace4321"));
        }
    };
